...
AGE_MODEL_PATH = "../model/identity/test12232/best_model.pt"
...
faceProto = "../model/Adience/opencv_face_detector.pbtxt"
faceModel = "../model/Adience/opencv_face_detector_uint8.pb"
...
ADD_CLASS = 15
AGE_NUM = 5
AGE_CLASS = {0:'senior', 1:'high', 2:'collage', 3:'graduate', 4:'professor'}
...
def AgePredict(image_np):
    ...
    with torch.set_grad_enabled(False):
        ...
        predict_levels = probas > 0.5
        predicted_label = torch.sum(predict_levels, dim=1)
        #print('Predicted iden:', predicted_label.item())
        agePredict = predicted_label.item()
        print('iden:',AGE_CLASS[agePredict])
        return AGE_CLASS[agePredict]
...
#cap = cv.VideoCapture("test1_3F.mp4")
